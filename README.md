...
### 🧹 Очищення ресурсів
Щоб уникнути списання коштів після завершення роботи:
    1. Видаліть усі файли з бакета (Bucket).
    2. Виконайте команду terraform destroy.
    3. Видаліть образи контейнерів з Artifact Registry.